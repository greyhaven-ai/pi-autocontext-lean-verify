...
/-- Challenge v13: full simultaneous keep/drop metrics through tree mirror, with metric groups in a different order. -/
theorem partitionReorderedMetrics_flatten_mirror (target : Nat) (tree : NatTree) :
