...
A v7 stability probe should repeat the two seeded-failed fixtures only:

- `challenge_v7_partition_stats_acc_mirror`
- `challenge_v7_partition_reassemble_stats_acc_mirror`

If seeded remains unstable across repeats, package these fixtures and reports as the next benchmark-content release (`0.1.9`).
