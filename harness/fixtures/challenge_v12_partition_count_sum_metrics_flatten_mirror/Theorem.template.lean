...
/-- Challenge v12: simultaneous keep/drop count and sum metric pairs through tree mirror. -/
theorem partitionCountSumMetrics_flatten_mirror (target : Nat) (tree : NatTree) :
