...
| ---------------------------------------------------------- | --------------------------: | ------------------------------------------------------------------------------------------------- |
| Harness sanity: every expected proof still verifies        | 52 / 52 expected-proof fixtures (104 manifest fixtures) | `benchmark_manifest.json` plus fixture `expected_proof.lean` checks                               |
