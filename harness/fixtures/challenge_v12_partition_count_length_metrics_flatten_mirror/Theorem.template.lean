...
/-- Challenge v12: simultaneous keep/drop count and length metric pairs through tree mirror. -/
theorem partitionCountLengthMetrics_flatten_mirror (target : Nat) (tree : NatTree) :
