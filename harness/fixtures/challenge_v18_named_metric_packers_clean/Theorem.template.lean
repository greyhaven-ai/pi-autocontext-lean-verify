...
/-- Compact named length/count/sum pair packers plus append/filter helper lemmas. -/
theorem orderLengthCountSum_named_metric_packers_clean (target : Nat) (tree : NatTree)
