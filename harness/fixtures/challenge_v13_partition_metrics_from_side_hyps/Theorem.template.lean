...
/-- Challenge v13: reassemble metric-grouped conclusion from side-grouped keep/drop metric hypotheses only. -/
theorem partitionMetrics_from_side_hyps (target : Nat) (tree : NatTree)
