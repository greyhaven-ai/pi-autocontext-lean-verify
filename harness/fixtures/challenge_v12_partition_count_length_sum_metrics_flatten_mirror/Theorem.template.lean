...
/-- Challenge v12: simultaneous keep/drop count, length, and sum metric bundles through tree mirror. -/
theorem partitionCountLengthSumMetrics_flatten_mirror (target : Nat) (tree : NatTree) :
