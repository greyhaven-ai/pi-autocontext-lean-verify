...
/-- Challenge v11: prove both keep and drop metric bundles without lifting to statsAcc. -/
theorem partitionMetricBundles_flatten_mirror (target : Nat) (tree : NatTree) :
