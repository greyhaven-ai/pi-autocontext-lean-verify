...
/-- Challenge v14: simultaneous keep/drop metric bundle through tree mirror, metric order length_count_sum. -/
theorem partitionMetricsOrderLengthCountSum_flatten_mirror (target : Nat) (tree : NatTree) :
