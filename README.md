...
- v25 step-prefix exact-label setup: reuses the two clean v18 fixtures, preserves the exact v18 semantic label roots, and replaces the original prefix with `step_`.
