...
/-- Challenge v14: simultaneous keep/drop metric bundle through tree mirror, metric order count_length_sum. -/
theorem partitionMetricsOrderCountLengthSum_flatten_mirror (target : Nat) (tree : NatTree) :
