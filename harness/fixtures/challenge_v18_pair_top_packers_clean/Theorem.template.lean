...
/-- Compact generic pair and top-level Prop packers plus append/filter helper lemmas. -/
theorem orderLengthCountSum_pair_top_packers_clean (target : Nat) (tree : NatTree)
