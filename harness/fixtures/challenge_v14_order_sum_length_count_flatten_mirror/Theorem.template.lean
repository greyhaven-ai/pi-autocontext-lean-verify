...
/-- Challenge v14: simultaneous keep/drop metric bundle through tree mirror, metric order sum_length_count. -/
theorem partitionMetricsOrderSumLengthCount_flatten_mirror (target : Nat) (tree : NatTree) :
