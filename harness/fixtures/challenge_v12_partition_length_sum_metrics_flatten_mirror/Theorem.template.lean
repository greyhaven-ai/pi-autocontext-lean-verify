...
/-- Challenge v12: simultaneous keep/drop length and sum metric pairs through tree mirror. -/
theorem partitionLengthSumMetrics_flatten_mirror (target : Nat) (tree : NatTree) :
