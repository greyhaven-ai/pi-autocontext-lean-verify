...
/-- Challenge v14: simultaneous keep/drop metric bundle through tree mirror, metric order sum_count_length. -/
theorem partitionMetricsOrderSumCountLength_flatten_mirror (target : Nat) (tree : NatTree) :
