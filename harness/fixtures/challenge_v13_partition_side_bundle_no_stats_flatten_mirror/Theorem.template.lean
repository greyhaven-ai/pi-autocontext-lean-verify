...
/-- Challenge v13: full keep/drop metric bundles grouped by side, without unrelated statsAcc definitions. -/
theorem partitionSideBundleNoStats_flatten_mirror (target : Nat) (tree : NatTree) :
